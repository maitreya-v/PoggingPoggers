          ...
          children={
            <div className="flex w-[360px] flex-col gap-3 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none sm:w-[460px]">
              ...
              <button className="flex items-center w-full">
                ...
                <div className="flex flex-col justify-center w-full h-full px-1 text-sm rounded-lg ms-2">
                  <p className="mb-1 text-base font-bold text-gray-900 text-start dark:text-white">
                    New Update: Horizon UI Dashboard PRO
                  </p>
                  <p className="text-xs text-gray-900 font-base text-start dark:text-white">
