const FreeCard = () => {
  return (
    <div className="relative mt-14 flex w-[256px] justify-center rounded-[20px] bg-gradient-to-br from-[#868CFF] via-[#432CF3] to-brand-500 pb-4">
      ...
      <div className="flex flex-col items-center mt-16 h-fit">
        <p className="text-lg font-bold text-white">Upgrade to PRO</p>
        <p className="px-4 mt-1 text-sm text-center text-white">
          Improve your development process and start doing more with EttarraVision 
          PRO!
        </p>
