              ...
              <tr {...headerGroup.getHeaderGroupProps()} key={index}>
                {headerGroup.headers.map((column, index) => (
                  <th
                    ...
                    key={index}
                  >
                    <div className="flex items-center justify-between pt-4 pb-2 tracking-wide text-gray-600 uppercase text-start sm:text-xs lg:text-xs">
              ...
              return (
                <tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    ...
                    } else if (cell.column.Header === "Metric") {
                      data = (
                        <p className="font-medium text-gray-600 text-md dark:text-white">
                          {cell.value}
                        </p>
                      );
